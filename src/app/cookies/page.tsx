...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description:
    "Cookie Policy for Humanly Staffing Inc. Learn how we use cookies, tracking technologies, and how to manage your preferences.",
};
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none prose-headings:scroll-mt-20 prose-h2:text-2xl prose-h2:font-bold prose-h2:text-gray-900 prose-h2:border-b prose-h2:border-gray-200 prose-h2:pb-3 prose-h3:text-xl prose-h3:font-semibold prose-h3:text-gray-800 prose-p:text-gray-700 prose-li:text-gray-700">
          ...
          <section id="section-2" className="mb-12">
            ...
            <p>
              First-party cookies are set directly by Humanly Staffing (humanlystaffing.com). These cookies are used to enable core website functionality, remember your preferences, and analyze how you use our website.
            </p>
