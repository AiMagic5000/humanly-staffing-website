              ...
              <div>
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  <div>
                    ...
                    <Input defaultValue="Humanly Staffing Inc." />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Site URL
                    </label>
                    <Input defaultValue="https://humanlystaffing.com" />
                  </div>
              ...
              <div>
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  <div>
                    ...
                    <Input defaultValue="support@humanlystaffing.com" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Phone Number
              ...
              <div>
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <Input defaultValue="noreply@humanlystaffing.com" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      SMTP Password
