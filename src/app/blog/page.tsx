...
export const metadata: Metadata = {
  title: "Blog",
  description: "Insights, tips, and trends in staffing, recruitment, and career development from Humanly Staffing.",
};
...
const posts = [
  ...
  },
  {
    ...
    title: "Healthcare Staffing Trends to Watch in 2025",
  ...
  },
  {
    ...
    title: "Financial Services Hiring Outlook for 2025",
      ...
      <section className="py-12 bg-white border-b border-gray-100">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2 items-center">
            <div className="aspect-video bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl" />
            <div>
