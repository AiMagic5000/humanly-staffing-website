...
const authors = {
  ...
  "Antonio Goldwire": {
    ...
    bio: "Antonio founded Humanly Staffing with a vision to transform how companies find and hire talent. His leadership has helped the company grow to serve over 500 clients nationwide.",
    linkedin: "https://linkedin.com",
    twitter: "https://twitter.com",
  },
};
...
const posts = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>At Humanly Staffing, we help companies build effective remote and hybrid teams. <a href="/employers/request-talent">Contact us</a> to learn how we can support your distributed workforce needs.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>At Humanly Staffing, our healthcare division specializes in connecting healthcare organizations with exceptional clinical and administrative talent. <a href="/industries/healthcare">Learn more about our healthcare staffing solutions</a>.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>At Humanly Staffing, our career coaches provide personalized interview preparation support. <a href="/contact">Contact us</a> to learn how we can help you land your next role.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>At Humanly Staffing, we provide salary guidance and negotiation support to our candidates. <a href="/jobs">Explore opportunities</a> where we can advocate for your worth.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>At Humanly Staffing, diversity and inclusion are core to our mission. We partner with organizations committed to building diverse teams. <a href="/employers/request-talent">Let's discuss how we can support your DE&I goals</a>.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>At Humanly Staffing, we help manufacturing companies find talent ready for the future of work. <a href="/industries/manufacturing">Learn about our manufacturing staffing solutions</a>.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>At Humanly Staffing, we help organizations build strong teams that last. <a href="/employers/request-talent">Partner with us</a> to find and retain exceptional talent.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>At Humanly Staffing, our finance and accounting practice connects exceptional professionals with leading organizations. <a href="/industries/finance">Explore opportunities in financial services</a>.</p>
    `,
  },
];
