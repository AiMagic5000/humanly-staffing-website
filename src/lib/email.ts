...
export const emailTemplates = {
    ...
    html: `
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <p>In the meantime, feel free to browse other opportunities on our <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://humanlystaffing.com"}/jobs" style="color: #3B82F6;">job board</a>.</p>

          <p>Best regards,<br>
          <strong>The Humanly Staffing Team</strong></p>

          <hr style="border: none; border-top: 1px solid #E5E7EB; margin: 30px 0;">

          <p style="font-size: 12px; color: #9CA3AF; text-align: center;">
            Humanly Staffing Inc.<br>
            1501 South Greeley Highway, Suite C, Cheyenne, WY 82007<br>
            <a href="tel:8888048424" style="color: #9CA3AF;">(888) 804-8424</a> |
            <a href="mailto:contact@humanlystaffing.com" style="color: #9CA3AF;">contact@humanlystaffing.com</a>
          </p>
        </body>
      </html>
    `,
  ...
  welcomeEmail: (data: { firstName: string }) => ({
    subject: "Welcome to Humanly Staffing!",
    html: `
      <!DOCTYPE html>
      <html>
        <head>
          <meta charset="utf-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Welcome to Humanly Staffing</title>
        </head>
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #1E40AF; margin: 0; font-size: 24px;">Humanly<span style="color: #1F2937;">Staffing</span></h1>
          ...
          <p>Thank you for joining Humanly Staffing! We're excited to help you find your next great opportunity.</p>
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://humanlystaffing.com"}/dashboard" style="display: inline-block; background: linear-gradient(135deg, #1E40AF 0%, #3B82F6 100%); color: white; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600;">Go to My Dashboard</a>
          </div>
    ...
    html: `
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://humanlystaffing.com"}/admin/applications" style="display: inline-block; background: linear-gradient(135deg, #1E40AF 0%, #3B82F6 100%); color: white; text-decoration: none; padding: 14px 28px; border-radius: 8px; font-weight: 600;">View Application</a>
          </div>

          <hr style="border: none; border-top: 1px solid #E5E7EB; margin: 30px 0;">

          <p style="font-size: 12px; color: #9CA3AF; text-align: center;">
            This is an automated notification from Humanly Staffing
          </p>
        </body>
      </html>
    `,
    ...
    html: `
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <p style="font-size: 12px; color: #9CA3AF; text-align: center;">
            This message was sent from the Humanly Staffing website contact form
          </p>
        </body>
      </html>
    `,
