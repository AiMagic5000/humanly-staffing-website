...
export const metadata: Metadata = {
  title: "Why Choose Us",
  description: "Discover why leading companies trust Humanly Staffing for their recruitment needs.",
};
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 py-20">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl font-bold text-white">Why Choose Humanly Staffing?</h1>
