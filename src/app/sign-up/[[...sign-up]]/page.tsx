...
export const metadata: Metadata = {
  title: "Sign Up",
  description: "Create your Humanly Staffing account to find your next career opportunity or hire top talent.",
};
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-indigo-600 to-blue-700">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          ...
          <p className="text-xl text-indigo-100 mb-8 max-w-md">
            Join thousands of professionals who have found their dream careers through Humanly Staffing.
          </p>
